...
void export_results_meta() {
   ...
   .def(
            "__getitem__",
            static_cast<
            vdjml::Aligner_info const& (Results_meta::*)(const vdjml::Aligner_id) const
   ...
   .def(
            "__getitem__",
            static_cast<
            vdjml::Gl_db_info const& (Results_meta::*)(const vdjml::Gl_db_id) const
            >(&Results_meta::operator[]),
            bp::return_internal_reference<>(),
   ...
   .def(
            "__getitem__",
            static_cast<
            vdjml::Gl_segment_info const& (Results_meta::*)(const vdjml::Gl_seg_id) const
            >(&Results_meta::operator[]),
            bp::return_internal_reference<>(),
