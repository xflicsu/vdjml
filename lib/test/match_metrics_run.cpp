...
BOOST_AUTO_TEST_CASE( case01 ) {
   Match_metrics mm1(42.2, -1, 0, 0, 0);
   ...
   Match_metrics mm2(42.2, -1, 0, 0, 0, true);
   ...
   Match_metrics mm3(42.2, -1, 0, 0, 0, false, true);
   ...
   Match_metrics mm4(42.2, -1, 0, 0, 0, false, true, true);
