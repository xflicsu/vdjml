...
'''
vdjml_py documentation build configuration file
'''
...
#by Václav Šmilauer <eu@doxos.eu>
#from miniEigen project at http://www.launchpad.net/minieigen/
...
project = u'__PROJECT__'
copyright = u'2013-4, __AUTHOR__'
...
latex_documents = [
  ('index', 'vdjml.tex', u'__PROJECT__ Documentation',
   u'__AUTHOR__', 'manual'),
]
...
man_pages = [
    ('index', 'vdjml', u'__PROJECT__ Documentation',
     [u'__AUTHOR__'], 1)
]
...
texinfo_documents = [
  ('index', 'vdjml', u'__PROJECT__ Documentation',
   u'__AUTHOR__', '__PROJECT__', '__DESCRIPTION__',
   'Bioinformatics'),
]
